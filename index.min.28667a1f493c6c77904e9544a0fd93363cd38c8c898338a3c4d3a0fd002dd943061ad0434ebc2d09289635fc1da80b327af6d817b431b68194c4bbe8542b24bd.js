...
ObjectSetProbe `}),e.add({id:14,href:"/docs/help/handover-process/",title:"Handover Process",description:`(Cluster)ObjectSet Lifecycle # stateDiagram-v2 direction LR state \u0026quot;Not Ready\u0026quot; as not_ready [*] --\u0026gt; Pending Pending --\u0026gt; Available Available --\u0026gt; not_ready Pending --\u0026gt; not_ready not_ready --\u0026gt; Available Available --\u0026gt; Archived not_ready --\u0026gt; Archived Archived --\u0026gt; [*] Pending
...
(Cluster)ObjectSet is shutdown and only acts as a revision tombstone for rollbacks.`,content:`(Cluster)ObjectSet Lifecycle # stateDiagram-v2 direction LR state \u0026quot;Not Ready\u0026quot; as not_ready [*] --\u0026gt; Pending Pending --\u0026gt; Available Available --\u0026gt; not_ready Pending --\u0026gt; not_ready not_ready --\u0026gt; Available Available --\u0026gt; Archived not_ready --\u0026gt; Archived Archived --\u0026gt; [*] Pending
Intermediate state before the controller posted it\u0026rsquo;s first update. Available
All availability probes are successful. Not Ready
One or more availability probes are unsuccessful. Archived
