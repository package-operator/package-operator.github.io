...
`}),e.add({id:2,href:"/docs/guides/packaging-an-application/",title:"Packaging an Application",description:"",content:""}),e.add({id:3,href:"/docs/getting_started/architecture/",title:"Architecture",description:"",content:""}),e.add({id:4,href:"/docs/guides/",title:"Guides",description:"",content:""}),e.add({id:5,href:"/docs/guides/installing-packages/",title:"Installing Packages",description:"",content:""}),e.add({id:6,href:"/docs/concepts/reconciliation/",title:"Object Reconciliation",description:`Package Operator is watching and if needed reconciling all objects under management.
...
apiVersion: apps/v1 kind: Deployment metadata: name: nginx-deployment labels: app: nginx spec: replicas: 3 template: {} `}),e.add({id:7,href:"/docs/concepts/",title:"Concepts",description:"",content:""}),e.add({id:8,href:"/docs/guides/packaging-an-operator/",title:"Packaging an Operator",description:"",content:""}),e.add({id:9,href:"/docs/getting_started/requirements/",title:"Requirements",description:"",content:""}),e.add({id:10,href:"/docs/getting_started/installation/",title:"Installation",description:"",content:""}),e.add({id:11,href:"/docs/concepts/probes/",title:"Probes",description:`Probes defines how Package Operator is judging the Availability of objects and is reporting status.
...
Package Operator is not providing any default probes and leaves it to the author of a package to configure probing explicitly.`,content:`Probes defines how Package Operator is judging the Availability of objects and is reporting status.
Defining Availability will depend on the specific application that is deployed.
In general, availability should reflect the health of the complete application bundle, so Package Operator can check whether it\u0026rsquo;s save to roll over to a new revision.
...
npm update [\u0026lt;pkg\u0026gt;...] `}),e.add({id:15,href:"/docs/help/troubleshooting/",title:"Troubleshooting",description:"Solutions to common problems.",content:`Problems updating npm packages # Delete the ./node_modules folder, and run again:
npm install Problems with cache # Delete the temporary directories:
npm run clean `}),e.add({id:16,href:"/docs/help/faq/",title:"FAQ",description:"Answers to frequently asked questions.",content:`Hyas? # Doks is a Hyas theme build by the creator of Hyas.
